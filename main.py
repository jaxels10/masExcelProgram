...
for product in excel_product_array:
    ...
    if product.buy_order_object is not None:
        worksheet.write('E' + str(index + 3), product.buy_order_object.month_1)
        worksheet.write('F' + str(index + 3), product.buy_order_object.month_2)
        worksheet.write('G' + str(index + 3), product.buy_order_object.month_3)
        worksheet.write('H' + str(index + 3), product.buy_order_object.month_4)
        worksheet.write('I' + str(index + 3), product.buy_order_object.month_5)
        worksheet.write('J' + str(index + 3), product.buy_order_object.month_6)
        worksheet.write('K' + str(index + 3), product.buy_order_object.month_7)
        worksheet.write('L' + str(index + 3), product.buy_order_object.month_8)
        worksheet.write('M' + str(index + 3), product.buy_order_object.month_9)
        worksheet.write('N' + str(index + 3), product.buy_order_object.month_10)
        worksheet.write('O' + str(index + 3), product.buy_order_object.month_11)
        worksheet.write('P' + str(index + 3), product.buy_order_object.month_12)

    if product.stock_object is not None:
        worksheet.write('E' + str(index + 4), product.stock_object.month_1)
        worksheet.write('F' + str(index + 4), product.stock_object.month_2)
        worksheet.write('G' + str(index + 4), product.stock_object.month_3)
        worksheet.write('H' + str(index + 4), product.stock_object.month_4)
        worksheet.write('I' + str(index + 4), product.stock_object.month_5)
        worksheet.write('J' + str(index + 4), product.stock_object.month_6)
        worksheet.write('K' + str(index + 4), product.stock_object.month_7)
        worksheet.write('L' + str(index + 4), product.stock_object.month_8)
        worksheet.write('M' + str(index + 4), product.stock_object.month_9)
        worksheet.write('N' + str(index + 4), product.stock_object.month_10)
        worksheet.write('O' + str(index + 4), product.stock_object.month_11)
        worksheet.write('P' + str(index + 4), product.stock_object.month_12)
